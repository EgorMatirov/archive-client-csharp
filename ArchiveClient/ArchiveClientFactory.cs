...
namespace ArchiveClient
{
    ...
    {
        public static IArchiveClient Create(string host, string clientCertificatePath, string clientKeyPath, string caCertificatePath)
        {
            ...
            var channel = new Channel(host, ssl);
